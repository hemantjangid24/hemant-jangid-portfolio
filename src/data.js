...
export const projects = [
  {
    id: 1,
    title: "RESPAWN - AI Powered Emergency Response System",
    description: "AI-powered emergency response platform connecting citizens, ambulances, hospitals, police, and fire services through real-time coordination.",
    longDescription: "A full-stack AI-driven emergency management system featuring one-tap SOS alerts, real-time GPS tracking, WebRTC video communication, smart ambulance dispatch, accident risk prediction, and demand forecasting using the MERN stack and FastAPI.",
    tech: [
      "FastAPI",
      "Python",
      "Socket.io",
    ...
    github: "https://github.com/hemantjangid24/RESPAWN-AI-Emergency-Response-System",
    live: "https://respawn-india.vercel.app",
    featured: true,
    color: "#ef4444",
    emoji: "🚨"
  },
  ...
  {
    id: 3, // Aapki list ke hisaab se ID set karein
    title: "ResuAI-Pulse",
