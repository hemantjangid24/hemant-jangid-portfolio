    ...
    >
      ...
      >
        ...
        >
          {/* LEFT */}
          <motion.div
            initial={{ opacity: 0, x: isMobile ? 0 : -22 }}
          ...
          >
            ...
            {INFO.map((item, i) => (
              <motion.div
                ...
                className="card"
                style={{
                  padding: isMobile ? '13px 15px' : '14px 16px',
                  display: 'flex',
                  alignItems: 'center',
                  gap: 12,
                }}
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  value={form.subject}
                  onChange={handleChange}
                  placeholder="Project inquiry / Internship / Just saying hi!"
                  className="input-field"
                />
              </div>
